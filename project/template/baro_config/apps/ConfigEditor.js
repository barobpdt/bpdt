##> widget
@eval {
	page = loadPage(cv('layout'))
}

layout: <>
	<page id="main" title="로그출력 페이지" module="SimpleDevTool">
		<splitter type="vbox">
	</page>

	// ##소스편집 
	<page id="editPanel" margin="0,8,0,0" module="EditPanel">
		<hbox>
	...
	// ##로그출력
	<page id="logPanel" margin="0,8,0,0" module="LogPanel">
		<hbox>
...
##> module {name=SimpleDevTool}
	init() {
        addModule(this, 'ApplicationPage')
